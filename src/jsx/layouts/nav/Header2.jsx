...
const Header2 = ({ onNote }) => {
  ...
  const [lockScreenvalue, setLockScreen] = useRecoilState(lockScreenAtom);
  const [walletActive, setWalletActive] = useRecoilState(walletActiveAtom);

  const toggleSideBarAdd = () => setWalletActive(!walletActive)

  const lockScreen = () => {
    localStorage.setItem(LOCK_SCREEN_TOKEN, !lockScreenvalue);
    setLockScreen(!lockScreenvalue);
  };
          ...
          <div className="collapse navbar-collapse justify-content-between">
            ...
            <ul className="navbar-nav header-right">
              ...
              <li className="nav-item dropdown notification_dropdown">
                <Link to={"#"} className="nav-link  menu-wallet" onClick={toggleSideBarAdd}>
                  ...
                  <Dropdown.Menu align="end" className="mt-1 dropdown-menu dropdown-menu-end" >
                    <div className="card mb-0">
                      ...
                      <div className="card-body p-3">
                        ...
                        <button className="btn dropdown-item ai-icon" onClick={lockScreen}>
                          ...
                          <span className="ms-2">Lock App </span>
                        </button>
                      </div>
